...
public class ConfirmPaidEventListener extends ApplicationEvent {
    ...
    public ConfirmPaidEventListener(Object source,Customer customer, Order order, Payment payment, String email) {
        super(source);
        this.order = order;
